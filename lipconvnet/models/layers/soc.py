...
class SOC(nn.Module):
    def __init__(
        ...
        if fast_train:
            # FIXME:
            raise NotImplementedError("SOC cudnn_convolution.cpp cannot be imported.")
        else:
        ...
        self.weight = nn.Parameter(
            torch.randn(self.max_channels, self.max_channels, self.kernel_size, self.kernel_size),
            requires_grad=True,
        )
